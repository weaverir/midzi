        ...
        <div className={"mt-4 bg-myblue flex flex-col items-center"}>
            <div className="bg-myblue w-full p-8 gap-32 font-sans_b flex flex-col md:flex-row md:justify-center">
                ...
                <div className="flex flex-col gap-3 justify-start items-start">
                    ...
                    <div><span className={"font-awsome"}></span> آدرس : آذربایجان شرقی - هادیشهر - خیابان پارک شهر -
                        جنب کوچه حسینی اقدم
                    </div>
                ...
                <h2 className="text-2xl mb-4">شبکه های مجازی</h2>
                    <div className={"items-center cursor-pointer select-none"} onClick={() => router.push(`https://www.instagram.com/midzi.ir?igsh=ZzhzdGlzN3Q0NzEz`)}><span className={"font-awsome_b my-2 text-3xl"} ></span> اینستاگرام
                    </div>
            ...
            <div className={"font-sans_b flex justify-center"}>
