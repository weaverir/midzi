    ...
    return (
        <div className="my-5 mx-4 font-sans">
            <div className="flex flex-row my-5 justify-center items-center">
                <div className='text-xl lg:text-3xl w-[45%] md:w-[35%] lg:w-[30%] xl:w-[25%] font-sans_b ml-5 flex justify-start  p-2 items-center'> تخفیف ها</div>
                <div className="w-[100%]  bg-cover border-t-4 dark:border-navblue border-stone-500 bg-center overflow-hidden"
                ></div>
            </div>
            <div className="flex flex-row mb-4 justify-between items-center">
                <button onClick={scrollLeftClick} className="p-2 bg-navblue rounded-full w-[40px] text-black dark:bg-navblueD dark:text-text_w ">▶</button>
                <div
                    ref={containerRef}
                    ...
                    className='flex select-none w-[100%] flex-row gap-4 scroll-auto no-scrollbar overflow-x-auto'
                >
                    {loading ? (
                ...
                <button onClick={scrollRightClick} className="p-2 bg-navblue rounded-full w-[40px] text-black dark:bg-navblueD dark:text-text_w ">◀</button>
            </div>
        </div>
    );
}
