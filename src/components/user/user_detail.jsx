        ...
        <>
            <div className="flex-1 bg-navblue dark:bg-navblueD dark:text-text_w p-4 rounded-xl shadow-lg">
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-text_w">(الزامی) نام خانوادگی</label>
                        <input
                            type="text"
                            name="last_name"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-text_w">(الزامی) شماره تلفن</label>
                        <input
                            type="text"
                            name="phone_number"
