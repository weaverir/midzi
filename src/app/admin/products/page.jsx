    ...
    return (
        <div className="p-4 bg-navblue dark:bg-navblueD dark:text-text_w rounded-2xl w-full">
            ...
            {loading && products.length === 0 ? (
                ...
                <>
                    {products.length > 0 ? (
                        <div className="overflow-y-auto max-h-screen w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {products.map((product) => (
                                <div key={product.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 flex flex-col mb-4 w-full">
                                    <div
